...
@section('content')
  ...
  <h1 class="mb-8 font-display text-2xl font-semibold">Novo compromisso</h1>

  <form method="POST" action="{{ route('admin.commitments.store') }}" class="card mx-auto max-w-3xl space-y-6 p-6 sm:p-8">
    @csrf
